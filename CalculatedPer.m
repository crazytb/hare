function [per1, per2] = CalculatedPer(pickedState, pickedAction, ebnodB, ppduLength, channelLevel, numLinks)
...
ebnodBPerLink(1) = 10^((ix(channelIndex(1)+1)+(3*harqIndex(1)*(bufferIndex(1))))/10);
ebnodBPerLink(2) = 10^((ix(channelIndex(2)+1)+(3*harqIndex(2)*(bufferIndex(2))))/10);
